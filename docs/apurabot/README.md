...
GIA entregue e com o Registro de Apuração do ERP.** 259 testes automáticos.
...
| [06 — Decisões pendentes](06-decisoes-pendentes.md) | **Fiscal/Tributário** | As perguntas em aberto, cada uma com o padrão assumido |
