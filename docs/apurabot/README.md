...
GIA entregue e com o Registro de Apuração do ERP.** 199 testes automáticos.
...
| [06 — Decisões pendentes](06-decisoes-pendentes.md) | **Fiscal/Tributário** | 13 perguntas em aberto, cada uma com o padrão assumido |
